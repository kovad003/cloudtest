...
public class Connections {
	...
	public static Connection getDevConnection() throws Exception{
		...
		config.setJdbcUrl("jdbc:mysql://localhost:3306/" + System.getProperty("databasename") + "?useSSL=false&" + System.getProperty("servertimezone")); // see appengine-web.xml
...
//config.setJdbcUrl("jdbc:mysql://localhost:3306/fishpooldb?useSSL=false&serverTimezone=America/New_York");
//config.setJdbcUrl("jdbc:mysql://localhost:3306/fishpooldb?serverTimezone=America/New_York");
//config.setJdbcUrl("jdbc:mysql://localhost:3006/fishpooldb?useLegacyDatetimeCode=false");
